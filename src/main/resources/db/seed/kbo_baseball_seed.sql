...
INSERT INTO baseball_stadium (id, name, latitude, longitude)
VALUES
    (1, '광주-KIA 챔피언스 필드', 35.168139, 126.889111),
    (2, '잠실야구장', 37.512389, 127.071972),
    (3, '대전 한화생명 볼파크', 36.316250, 127.431444),
    (4, '수원 KT 위즈 파크', 37.299778, 127.009667),
    (5, '고척 스카이돔', 37.498222, 126.867250),
    (6, '대구삼성라이온즈파크', 35.840917, 128.681611),
    (7, '인천 SSG 랜더스필드', 37.436778, 126.693306),
    (8, '사직야구장', 35.194028, 129.061611),
    (9, '창원 NC 파크', 35.222444, 128.581833)
